package com.jakey.recorduidemo.widget;
...
import com.jakey.recorduidemo.R;
import com.jakey.recorduidemo.utils.AudioRecordManager;
import com.jakey.recorduidemo.utils.VibratorUtils;

import java.io.File;


/**
 * Created by jakey on 2017/1/25
 */
public class RecorderButton extends Button implements AudioRecordManager.AudioStateListener {
    ...
    public RecorderButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        String dir = Environment.getExternalStorageDirectory() + File.separator + "jakey" + File.separator + "record";
